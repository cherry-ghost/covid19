---
title: "Modelling the effects of interventions on COVID-19 transmission"
description: |
  Examines the effect of various public health interventions on the local epidemic spread of COVID-19 infection using stochastic compartmental models implemented by the `EpiModel` library for R.  
output:
  pdf_document
editor_options: 
...
and
https://rviews.rstudio.com/2020/03/19/simulating-covid-19-interventions-with-r/?utm_content=buffer54b85&utm_medium=social&utm_source=linkedin&utm_campaign=buffer
