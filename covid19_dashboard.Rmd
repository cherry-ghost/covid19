...
This Coronavirus dashboard: Provides an overview of the 2019 Novel Coronavirus COVID-19 (2019-nCoV) epidemic for Switzerland. This dashboard is built with R using the R Makrdown framework. 
<br>
**Code**
<br>
...
<br>
*LinkedIn Profile [Mirco Heidemann](www.linkedin.com/in/mirco-heidemann)*.
